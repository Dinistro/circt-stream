...
// CHECK: handshake.func private @[[LABEL:.*]](%{{.*}}: tuple<tuple<i32, i64>, i1>, %{{.*}}: none, %{{.*}}: none, ...) -> (tuple<tuple<i64, i32>, i1>, none, none)
...
// CHECK-NEXT:   return %{{.*}}, %{{.*}}, %{{.*}} : tuple<tuple<i64, i32>, i1>, none, none
// CHECK-NEXT: }
// CHECK-NEXT: handshake.func @map(%{{.*}}: tuple<tuple<i32, i64>, i1>, %{{.*}}: none, %{{.*}}: none, ...) -> (tuple<tuple<i64, i32>, i1>, none, none)
// CHECK-NEXT:   %{{.*}}:3 = instance @[[LABEL]](%{{.*}}, %{{.*}}) : (tuple<tuple<i32, i64>, i1>, none, none) -> (tuple<tuple<i64, i32>, i1>, none, none)
// CHECK-NEXT:   return %{{.*}}#0, %{{.*}}#1, %{{.*}}#2 : tuple<tuple<i64, i32>, i1>, none, none
// CHECK-NEXT: }
