...
// CHECK: handshake.func private @[[LABEL:.*]](%{{.*}}: tuple<tuple<i32, i64>, i1>, %{{.*}}: none, ...) -> (tuple<tuple<i64, i32>, i1>, none)
...
// CHECK-NEXT: }
// CHECK-NEXT: handshake.func @map(%{{.*}}: tuple<tuple<i32, i64>, i1>, %{{.*}}: none, ...) -> (tuple<tuple<i64, i32>, i1>, none)
