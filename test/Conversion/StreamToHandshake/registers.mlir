...
// CHECK-SAME:      %[[VAL_0:.*]]: tuple<i32, i1>, %[[VAL_1:.*]]: none, ...) -> (tuple<i32, i1>, none)
...
// CHECK:           return %[[VAL_7]], %[[VAL_1]] : tuple<i32, i1>, none
// CHECK:         }


// CHECK-LABEL:   handshake.func @single_reg(
// CHECK-SAME:      %[[VAL_0:.*]]: tuple<i32, i1>, %[[VAL_2:.*]]: none, ...) -> (tuple<i32, i1>, none)
...
// CHECK-SAME:      %[[VAL_0:.*]]: tuple<i32, i1>, %[[VAL_1:.*]]: none, ...)
// CHECK:           %[[VAL_3:.*]]:2 = unpack %[[VAL_0]] : tuple<i32, i1>
